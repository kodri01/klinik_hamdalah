    ...
    <div class="container-fluid row mx-auto">
        <div class="mt-5">
            ...
            <div class="container row">
                <div class="card text-bg-primary m-3" style="max-width: 24rem;">
                    <div class="card-header fw-bold fs-4">Registrasi</div>
                    <div class="col">
                        <h1 class="text-end" style="font-size: 50px;"> <?php echo $user; ?></h1><a
                            href="vaksin_klinik/data_pasien" class="text-light"><i class="mb-2 fa-solid fa-user-gear"
                                style="font-size:6rem ;"></i></a>
                    </div>
                </div>
                <div class="card text-bg-warning m-3" style="max-width: 24rem;">
                    <div class="card-header fw-bold fs-4">Vaksinasi</div>
                    <div class="col">
                        <h1 class="text-end" style="font-size: 50px;"> <?php echo $total; ?></h1>
                        <a href="vaksin_klinik/vaksinasi" class="text-dark"><i class="mb-2 fa-solid fa-file-medical"
                                style="font-size:6rem ;"></i></a>
                    </div>
                </div>
                <div class="card text-bg-success m-3" style="max-width: 24rem;">
                    <div class="card-header fw-bold fs-4">Imunisasi</div>
                    <div class="col">
                        <h1 class="text-end" style="font-size: 50px;"> <?php echo $timun; ?></h1><a
                            href="vaksin_klinik/vaksin_anak" class="text-light"><i class="fa-solid fa-capsules"
                                style="font-size: 6rem;"></i></a>
                    </div>
                </div>
            </div>
