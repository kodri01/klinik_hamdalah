...
class Vaksin_klinik extends CI_Controller
{
	...
	{
		$data['update'] = $this->vaksin_model->data_register();
	...
	public function proses_update()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data = $this->vaksin_model->update_data($data, 'registrasi');
			return redirect('vaksin_klinik/register');
		}
	}
	...
	public function cetak_skrining($no_nik)
	{
		...
		// $data['skrining'] = $this->vaksin_model->data_skrining();
